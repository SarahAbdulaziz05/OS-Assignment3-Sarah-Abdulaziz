...
class SharedResources {
    ...
    public static final Semaphore cpuSemaphore = new Semaphore(1);  // Only 1 process can use CPU at a time
    ...
    public static List<String> executionLog = new ArrayList<>();  // Shared list - NEEDS PROTECTION!
      ...
      //method to increment context switch counter with lock protection
...
class Process implements Runnable {
    ...
    public void runToCompletion() {
        ...
        try {
            ...
            SharedResources.cpuSemaphore.release(); // Ensure semaphore is released even if an exception occurs
        }
        } catch (InterruptedException e) {
